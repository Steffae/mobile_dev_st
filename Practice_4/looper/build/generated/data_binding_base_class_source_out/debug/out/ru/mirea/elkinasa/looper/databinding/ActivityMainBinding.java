...
package ru.mirea.elkinasa.looper.databinding;
...
import ru.mirea.elkinasa.looper.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonSend,
      @NonNull EditText editTextAge, @NonNull EditText editTextJob,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editTextJob;
      EditText editTextJob = ViewBindings.findChildViewById(rootView, id);
      if (editTextJob == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, buttonSend, editTextAge,
          editTextJob, textViewResult);
    }
